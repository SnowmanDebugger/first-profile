...
# options = Options()
# options.add_experimental_option("/Usr/local/bin/ChromeDriver", "127.0.0.1:9222")
...
for i in range(7):
# 获取用户与密码输入框并输入
    driver.find_element_by_xpath('//*[@id="username"]').send_keys("2018901425")
    time.sleep(1)
    #driver.find_element_by_xpath('//*[@id="password"]').click()
    #time.sleep(1)[]
    driver.find_element_by_xpath('//*[@id="password"]').send_keys("zs2618351",Keys.ENTER)
    #time.sleep(4)
    title = driver.title
